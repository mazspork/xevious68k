...
fillscreen1:	move.l	d1,(a1)+
		...
		move	#setbit+copen+bplen+dmaen,dmacon(pad)
...
copperlist:	copmove	screen/$10000,bplpt
		copmove screen&$0FFFF,bplpt+2
		copwait	forever			; sleep until Vblank
...
regs_d7		dc.l	0
		dc.b	p_moretext,0,18,16,"SR : ",p_hexprint
regs_sr		dc.l	0
		dc.b	0
